  ...
  return (
    <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
      <div className="w-auto h-52 md:h-72 lg:h-96 py-3 md:py-6 lg:py-10 px-6 lg:px-20 bg-gradient-to-r flex justify-between from-gradient1 to-gradient2 rounded-3xl">
        ...
        <div className="my-5">
          ...
          <div className="flex justify-between mt-3">
            ...
            <p className=" text-base md:text-xl lg:text-2xl font-sans font-normal">7.0GB Data</p>
          </div>
          <div className="flex justify-between mt-3">
            <svg
              className="h-7 md:h-8 lg:h-10 w-7 md:w-8 lg:w-10"
            ...
            <p className="text-base md:text-xl lg:text-2xl font-sans font-normal">3hrs call</p>
          </div>
          <div className="flex justify-between mt-3">
            <svg
              className="h-7 md:h-8 lg:h-10 w-7 md:w-8 lg:w-10"
            ...
            <p className=" text-base md:text-xl lg:text-2xl font-sans font-normal">500+ SMS</p>
          </div>
        </div>
      </div>
      <div className=" mt-12">
      ...
      <div className="grid grid-cols-2 gap-5 lg:gap-10 justify-between mt-12">
        <div className=" bg-gradient-to-r from-glograd to-balancegrad2 w-auto h-44 lg:h-60 rounded-3xl px-5 py-7 lg:p-14 flex justify-between">
          <div>
            ...
            <p className=" text-base lg:text-2xl font-medium mb-3 text-[#000]">1GB ₦450</p>
            <p className=" text-base lg:text-2xl font-medium mb-3 text-[#000]">2.9GB ₦850</p>
          </div>
        ...
        <div className=" bg-gradient-to-r from-airtelgrad to-balancegrad2 w-auto h-44 lg:h-60 rounded-3xl px-2 py-7 lg:p-14 flex justify-between">
          <div>
            ...
            <p className=" text-base lg:text-2xl font-medium mb-3 text-[#000]">1GB ₦240</p>
          </div>
          <div className="place-self-center">
      ...
      <div className="w-auto flex justify-center my-12">
        <button className=" bg-[#FFF] text-base lg:text-2xl text-[##5D6C74] font-normal w-64 lg:w-72 h-10 lg:h-14 rounded-3xl ">FAQS | Contact Us</button>
      </div>
    </div>
  );
}
